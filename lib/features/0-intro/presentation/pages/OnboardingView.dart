          ...
          child:  Row(
            ...
            children: [
              ...
              TextButton(
                 ...
                 onPressed: ()=>NavigationHelper.goToAndReplace(HomeScreen()),
                  child:  Text('< '+TTexts.skip,style: MyFontStyles.greySemiBold16,)),
              ...
              TextButton(
                  ...
                  child:  Text(TTexts.pre,style: MyFontStyles.greySemiBold16,)),
                  ...
                  children: [
                    ...
                    Center(
                      child: SizedBox(
                        ...
                        child: Stack(
                          ...
                          children: [
                            SvgPicture.asset(ImageApp.onBoardingLine,fit: BoxFit.fitWidth,),
                            ...
                            ClipRect(
                              child: Align(
                                  ...
                                  child: SvgPicture.asset(ImageApp.onBoardingLine3,fit: BoxFit.fitWidth,)
                              ),
                            ),
                    ...
                    Padding(
                      ...
                      child: Text(controller.items[index].descriptions,
                          style: MyFontStyles.greyMedium18, textAlign: TextAlign.end),
                    ),
                    SizedBox(height: 64.h),
                    Center(child: MainButton(title: TTexts.next,
                      onPressed: ()async{
                        ...
                        THelperFunctions.navigateAndReplaceScreen(IntroductoryScreen());
                      },
                    ))
